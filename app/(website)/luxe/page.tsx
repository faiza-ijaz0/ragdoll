...
function VideoGallery({ 
  ...
  // Fetch videos from Firebase - NO LOADING STATE
  useEffect(() => {
...
function ViewDetailsModal({ 
  ...
  // Fetch agent data - NO LOADING STATE
  useEffect(() => {
                ...
                <div className="space-y-10">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2">
                        <span className="px-4 py-1 bg-primary/10 text-primary text-[10px] font-black uppercase tracking-[0.2em] rounded-full">
                          {property.type?.toUpperCase() || "LUXURY PROPERTY"}
                        </span>
                    ...
                    <div className="prose prose-slate max-w-none">
                      <p className="text-slate-600 leading-relaxed text-lg whitespace-pre-line font-medium bg-slate-50 p-8 rounded-3xl border border-slate-100">
                        {property.description ||
                          "Experience luxury living in this exceptional property located in Dubai. This residence offers premium amenities and prime location."}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6 pt-10 border-t border-slate-100">
                    ...
                    <p className="text-slate-600 text-lg">
                      Get detailed information about this luxury property.
                    </p>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600 group-hover:text-white/80">
                              Complete luxury property information
                            </p>
                          </div>
                        </div>
                      </button>
                ...
                <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white shadow-2xl shadow-slate-900/20 relative overflow-hidden">
                  ...
                  <div className="relative z-10 space-y-6">
                    <h3 className="text-2xl font-black tracking-tight">
                      Interested in this Luxury Property?
                    </h3>
                    <p className="text-slate-400 text-sm font-medium leading-relaxed">
                      Fill out the form below for exclusive inquiries.
                    </p>
