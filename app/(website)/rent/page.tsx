...
import {
  ...
  HeartIcon,
  PhotoIcon,
  Squares2X2Icon, // Added for gallery icon
  PlayCircleIcon, // Added for video play button
...
// Full Screen Gallery Component - UPDATED WITH FIXES
...
function ViewDetailsModal({ 
  ...
  const [showFullScreenGallery, setShowFullScreenGallery] = useState(false); // NEW: Gallery state
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 bg-white overflow-y-auto">
        ...
        <div className="container-custom pt-8 pb-12 mt-25">
          ...
          <p className="text-xl mb-2 font-bold text-slate-500">Properties For Rent </p>
...
function PropertiesPageContent() {
  ...
  const [showFullScreenGallery, setShowFullScreenGallery] = useState(false); // NEW: State for modal gallery
  ...
  // NEW: Function to open gallery from main image
  const handleGalleryOpenFromModal = (property: NormalizedProperty) => {
    setShowFullScreenGallery(true);
  };

  // Function to open gallery from thumbnail
