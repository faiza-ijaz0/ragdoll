...
//                           {property.type?.toUpperCase() || "APARTMENT"}
//                         </span>
...
//                         ≈ AED {formatPrice(Math.round((property.price || 0) / 12))}/month
//                       </div>
//                     </div>
//                   </div>
...
//         p.area?.toLowerCase().includes(formState.area.toLowerCase()) || 
//         p.city?.toLowerCase().includes(formState.area.toLowerCase()) ||
//         p.location?.toLowerCase().includes(formState.area.toLowerCase())
//       );
//     }
...
//     title += formState.action === 'rent' ? ' for Rent' : ' for Sale';
...
//     desc += formState.action === 'rent' ? ' for rent' : ' for sale';
...
// Filter by area/location - COMPLETE FIXED VERSION
if (formState.area) {
