              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between">
                <div>
                  ...
                  <p className="text-white/80 text-lg">
                    {agentData?.brokerage || "Global Property Solutions"}
                  </p>
                </div>
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white border border-slate-200 rounded-xl p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(
                        agentData?.specializations || ["Rental Properties"]
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white border border-slate-200 rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                      {(agentData?.certifications || ["RERA Certified"]).map(
                  ...
                  <div className="absolute top-4 left-4 right-4 flex justify-between">
                    <div className="flex gap-2">
                      <span className="px-4 py-2 bg-primary text-white text-sm font-bold rounded-full shadow-lg">
                        {property.status === "rent" ? "FOR RENT" : "PROPERTY"}
                      </span>
                      {property.featured && (
                  ...
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-slate-500 mt-1">
                        ≈ AED{" "}
                        {formatPrice(Math.round((property.price || 0) / 12))}
                        /month
                      </div>
                    </div>
                  </div>
...
async function fetchRentPropertiesFromMainCollection() {
  try {
    ...
    const q = query(propertiesRef, where("status", "==", "rent"));
...
function PropertiesPageContent() {
  ...
  const handleVideoFilterChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    router.replace(`/rent?${params.toString()}`, { scroll: false });
  };
    ...
    try {
      ...
      if (detailedProperty) {
        const normalized = {
          ...
          type:
            detailedProperty.type || detailedProperty.subtype || "Apartment",
  ...
  const getPageTitle = () => {
    ...
    } else if (formState.category === "luxe") {
      title += "Properties";
    } else {
      title += "Properties";
    }
  ...
  const getPageDescription = () => {
    ...
    desc +=
      ". Browse our curated selection with detailed information and high-quality images.";
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
              ...
              <div className="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-400 text-sm font-medium mb-6 leading-relaxed">
                    Our expert agents are ready to help you find your perfect
                    rental property.
                  </p>
                  <Link
                    href={"/contact"}
          ...
          <main className="lg:w-3/4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 sm:mb-10 gap-4 sm:gap-6 bg-white p-4 sm:p-4 rounded-2xl sm:rounded-3xl border border-slate-100 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto"></div>
            </div>
              ...
              <div className="text-center py-32 bg-white rounded-[3rem] border border-slate-100 shadow-sm">
                ...
                <p className="text-slate-500 font-medium max-w-xs mx-auto">
                  {allProperties.length === 0
                    ...
                    : showOnlyVideos
                      ? "No rental properties with video tours found matching your criteria."
