      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-24">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-lg text-slate-400 mb-10 leading-relaxed max-w-md">
              Redefining luxury real estate in Dubai. We provide bespoke
              property solutions for the world's most discerning investors.
            </p>

            <div className="space-y-6">
              <h4 className="text-white font-bold uppercase tracking-widest text-sm">
                {t("footer.subscribeToEliteList")}
              </h4>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-center gap-4">
                ...
                <span className="text-sm">+971(0) 43427561</span>
              </li>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-sm text-slate-500">
            © {currentYear} RAGDOLL PROPERTIES Premium Real Estate. All rights
            reserved.
          </div>
